...
public class EditPersonCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, VALID_NAME_AMY + INVALID_PHONE_DESC + EMAIL_DESC_AMY,
        ...
        assertParseFailure(parser, VALID_NAME_AMY + INVALID_NAME_DESC + INVALID_EMAIL_DESC + VALID_PHONE_AMY,
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = VALID_NAME_AMY + NAME_DESC_BOB + PHONE_DESC_BOB + TAG_DESC_HUSBAND
    ...
    public void parse_someFieldsSpecified_success() {
        Name personName = new Name(VALID_NAME_AMY);
        String userInput = personName + PHONE_DESC_BOB + EMAIL_DESC_AMY;
    ...
    public void parse_oneFieldSpecified_success() {
        // name
        Name personName = new Name(VALID_NAME_BOB);
        String userInput = personName + NAME_DESC_AMY;
        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY).build();
        EditPersonCommand expectedCommand = new EditPersonCommand(personName, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);

        // phone
        userInput = personName + PHONE_DESC_AMY;
        descriptor = new EditPersonDescriptorBuilder().withPhone(VALID_PHONE_AMY).build();
        expectedCommand = new EditPersonCommand(personName, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);

        // email
        userInput = personName + EMAIL_DESC_AMY;
        descriptor = new EditPersonDescriptorBuilder().withEmail(VALID_EMAIL_AMY).build();
        expectedCommand = new EditPersonCommand(personName, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);

        // tags
        userInput = personName + TAG_DESC_FRIEND;
    ...
    public void parse_multipleRepeatedFields_failure() {
        ...
        Name personName = new Name(VALID_NAME_AMY);
        String userInput = personName + INVALID_PHONE_DESC + PHONE_DESC_BOB;

        assertParseFailure(parser, userInput, Messages.getErrorMessageForDuplicatePrefixes(PREFIX_PHONE));

        // invalid followed by valid
        userInput = personName + PHONE_DESC_BOB + INVALID_PHONE_DESC;

        assertParseFailure(parser, userInput, Messages.getErrorMessageForDuplicatePrefixes(PREFIX_PHONE));

        // mulltiple valid fields repeated
        userInput = personName + PHONE_DESC_AMY + EMAIL_DESC_AMY
        ...
        userInput = personName + INVALID_PHONE_DESC + INVALID_EMAIL_DESC
    ...
    public void parse_resetTags_success() {
        Name personName = new Name(VALID_NAME_AMY);
        String userInput = personName + TAG_EMPTY;
